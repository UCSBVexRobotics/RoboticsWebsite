...
const Outreach = () => {
    ...
    return(
        <div>
            ...
            <p className="text">
            We are currently reaching out to elementary schools in our local community to figure out how we may collaborate in the near future to establish after-school programs for local students. We are mainly in the planning stages, creating the infrastructure and building the connections necessary to achieve our goals.
            </p>
        </div>
    )
}
